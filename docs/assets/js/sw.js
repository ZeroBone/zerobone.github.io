...
const CONTENT_CACHE = "content--2020-09-05T18:40:12+02:00--sw/";
...
const SHELL_FILES = [
  "/assets/js/zerobone-v.js",
  "/assets/css/zerobone.css",
...
function isSameSite({ origin, pathname }) {
  return origin.startsWith("https://zerobone.net") && pathname.startsWith("");
}
